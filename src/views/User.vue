                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <div class="m-b-25"> <img src="../assets/user.png" class="img-radius" alt="User-Profile-Image" width="50" height="50"> </div>
                                <h6 class="f-w-600">Petar Markov</h6>
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400">primjer@gmail.com</h6>
                                    </div>
                                    <div class="col-sm-6">
...
.bg-c-lite-green {
    background: -webkit-gradient(linear, left top, right top, from(#ff8800), to(#f1b603));
